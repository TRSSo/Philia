...
export type Event = BotOffline | MessageReceive | MessageRecall | FriendRequest | GroupRequest | GroupInvitation | FriendNudge | FriendFileUpload | GroupAdminChange | GroupEssenceMessageChange | GroupMemberIncrease | GroupMemberDecrease | GroupNameChange | GroupMessageReaction | GroupMute | GroupWholeMute | GroupNudge | GroupFileUpload;
