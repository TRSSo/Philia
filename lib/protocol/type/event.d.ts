...
export type Notice = UserInfo | GroupInfo | GroupMemberInfo | BotOffline | UserMessageRecall | GroupMessageRecall | UserPoke | GroupPoke | UserFileUpload | GroupFileUpload | GroupEssenceMessage | GroupMember;
/** 请求事件基类 */
