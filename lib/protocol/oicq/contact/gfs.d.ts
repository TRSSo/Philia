...
export declare class Gfs {
  ...
  constructor(c: Client, gid: string);
  /** 获取使用空间和文件数 */
  df(): Promise<{
    total: number;
    used: number;
  ...
  /** {@link dir} 的别名 */
  get ls(): (pid?: string, start?: number, limit?: number) => Promise<(GfsFileStat | GfsDirStat)[]>;
  /** 创建目录(只能在根目录下创建) */
   ...
   * @returns 上传的文件属性
   */
  upload(file: string | Buffer, pid?: string, name?: string): Promise<GfsFileStat | {
    fid: string;
  }>;
  /**
   * 将文件转发到当前群
