...
export declare const ExtendArray: ExtendMessageElem["type"][];
export type BaseMessageElem = TextElem | ImageElem | AtElem | ReplyElem | FileElem | FileIDElem | PttElem | VideoElem | ForwardNode | MarkdownElem | ButtonElem | QuoteElem | ExtendElem | PlatformElem;
export type ExtendMessageElem = FaceElem | BfaceElem | MfaceElem | MiraiElem | FlashElem | JsonElem | XmlElem | PokeElem | LocationElem | ShareElem | MusicElem | LongMsgElem;
